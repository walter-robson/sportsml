...
export function Sidebar() {
  ...
  return (
    <nav className="flex flex-col gap-px bg-bg-panel border-r border-border h-full w-[200px] py-3 px-2.5">
      <Link
        href="/apps/lineup-analysis"
        className="mono text-white font-semibold text-[13px] px-2 pt-1 pb-3 tracking-tight"
      >
      ...
      {SECTIONS.map((section) => (
        <div
          key={section.label}
          className={cn("flex flex-col gap-px", section.pushDown && "mt-auto")}
        >
              ...
              <Link
                ...
                className={cn(
                  ...
                  active
                    ...
                    : "text-[#bbb] hover:bg-bg-hover hover:text-white",
                )}
              >
                {active && (
