...
export function mockListOntologyTypes(): ReadonlyArray<ObjectType> {
  return [
    ...
    {
      id: "basketball.nba.possession",
      name: "Possession",
      sport_id: "basketball.nba",
      count: 1318472,
    },
    {
      id: "basketball.nba.shot",
      name: "Shot",
      sport_id: "basketball.nba",
      count: 1102845,
    },
    {
      id: "basketball.nba.lineup",
      name: "Lineup",
      sport_id: "basketball.nba",
      count: 28940,
    },
    {
      id: "basketball.nba.lineup_stint",
      name: "LineupStint",
      sport_id: "basketball.nba",
      count: 184320,
    },
    {
      id: "basketball.nba.draft_prospect",
      name: "DraftProspect",
      sport_id: "basketball.nba",
      count: 138,
    },
    {
      id: "basketball.ncaa.player_season",
      name: "NCAAPlayerSeason",
      sport_id: "basketball.ncaa",
      count: 4912,
    },
    {
      id: "basketball.ncaa.team_season",
      name: "NCAATeamSeason",
      sport_id: "basketball.ncaa",
      count: 363,
    },
...
export function mockListDatasets(): ReadonlyArray<Dataset> {
  ...
  return [
    {
      id: "basketball.nba.possessions",
      name: "basketball.nba.possessions",
      rows: 1318472,
      last_updated: hoursAgo(6),
    },
    {
      id: "basketball.nba.shots",
      name: "basketball.nba.shots",
      rows: 1102845,
      last_updated: hoursAgo(6),
    },
    {
      id: "basketball.nba.lineup_stints",
      name: "basketball.nba.lineup_stints",
      rows: 184320,
      last_updated: hoursAgo(6),
    },
    {
      id: "features.nba.player_season_stats",
      name: "features.nba.player_season_stats",
      rows: 2740,
      last_updated: hoursAgo(2),
    },
    {
      id: "features.nba.lineup_season_stats",
      name: "features.nba.lineup_season_stats",
      rows: 28940,
      last_updated: hoursAgo(2),
    },
    {
      id: "features.nba.on_off_stints",
      name: "features.nba.on_off_stints",
      rows: 184320,
      last_updated: hoursAgo(2),
    },
    {
      id: "features.nba.shot_quality",
      name: "features.nba.shot_quality",
      rows: 320,
      last_updated: hoursAgo(2),
    },
    {
      id: "features.nba.prospect_features",
      name: "features.nba.prospect_features",
      rows: 138,
      last_updated: hoursAgo(12),
    },
    {
      id: "basketball.ncaa.player_seasons",
      name: "basketball.ncaa.player_seasons",
      rows: 4912,
  ...
  return [
    {
      ...
      sport_id: "basketball.nba",
      description:
        "Bayesian-shrunk RAPM with matchup adjustment. Scores observed 5-man lineups and projects unseen ones with confidence bands.",
    },
    {
      ...
      sport_id: "basketball.nba",
      description:
        "NCAA per-40 → projected NBA per-36 with confidence bands. Trained on historical draft cohorts.",
    },
  ];
}
